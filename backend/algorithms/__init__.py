...
# Import algorithms 觸發 register (zigzag 係第一個, M1 ma_alignment 係第二個, M2 hl_structure 係第三個, M3 trendline 係第四個, M4 indicators 係第五個, M5 volume_price 係第六個, M6 volatility 係第七個, 之後加 M7 synthesizer 喺呢度加)
