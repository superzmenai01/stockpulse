    ...
    ;(async () => {
      try {
        ...
        if (flagMarkers.length > 0) {
          ...
          console.log('[EW Test ZigZag] ✅ 橙色 #FF9800 旗仔 marker set:', flagMarkers.length, '個 (大少 2026-08-30 17:50 旗仔 marker)')
        } else {
          console.log('[EW Test ZigZag] ℹ️ 沒有任何 decisionTime/decisionValue point, 旗仔 marker skip')
        }
      } catch (e) {
        if (!controller.signal.aborted) {
