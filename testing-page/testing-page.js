...
const ALGO_CACHE_BUST = '4.92.0';  // 大少 2026-09-11 07:32 Fix D — decisionEngineToStandardVerdict 拎 backend verdict 嘅 state / confidence path 永遠拎 verdict.meta.* 優先 (backend v0.1-v2.x 統一 emit 喺 meta), 之前拎 verdict.state (top level) 永遠 undefined, fallback SIDEWAYS 0 導致 6 個 module 全部「橫行」+「未確認」+ 信心 0 (大少 9月11日 07:32 撳跑 synth 00700 trigger, 6 個 module verdict 應該對齊 backend M1=DOWN conf 0.4145 等); 對齊 §Cache bust self-check 永久 rule 21:24 sync bump ?v=2.3.170 → 2.3.171; 對齊 §M7 v2.0.1 永久 rule spirit「frontend display 永遠對齊 backend verdict shape」
