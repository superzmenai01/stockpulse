...
const ALGO_CACHE_BUST = '4.90.0';  // 大少 2026-09-10 11:30 Spec Sync #54 v2.0.1 A+D reliability fix: backend + frontend quality 0.7→0.5 (放寬 mtf_squeeze_fire) + 加 regime_pass_setup 新 setup type (regimeGate=PASS 但 setup=空 嗰陣出"有方向等突破" 0.45)
