...
// 大少 2026-08-11 M8 v3 fix: ALGO_CACHE_BUST = '3.6.1' (M8 v2 → v2.2.0 改動: 中長線/短炒 + 預設中長線 + MA trigger 永久 false fix + 全版中文化 + 補 popup tooltip + hardcoded template 5 個 trigger + cycle transition 標籤中文化)
const ALGO_CACHE_BUST = '3.6.1';
