...
const ALGO_CACHE_BUST = '4.91.0';  // 大少 2026-09-10 23:10 Step 7 Spec Sync #62 v2.0.0: frontend 1:1 port modules/synthesizer.ts v2.0.0 + types.ts SynthesizerVerdict 加 8 個新 field (weight_discounts / conflict_pairs / consensus_state / final_state 等), testing page 撳跑 synth 拎到 verdict 會見到新 field; 對齊 §Cache bust self-check 永久 rule 21:24 sync bump ?v=2.3.169 → 2.3.170; 對齊 §M7 v2.0 永久 rule (8-stage architecture generalize §M2 self-check weight 折扣)
